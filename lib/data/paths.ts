import {
    ...
    BadgePlus,
    Bell,
    BriefcaseBusiness, CircleCheckBig, ClipboardMinus,
    Command,
    GalleryVerticalEnd,
    HeartHandshake, Megaphone, PackageSearch, RefreshCcw, Store,
    Tag, Truck, Users
} from "lucide-react";
    ...
    navMains: [
        {
            ...
            url: "/dashboard",
            icon: BadgePlus,
            permission: [SYS_ROLES.ROLE_USER,SYS_ROLES.ROLE_HDO_ADMIN,SYS_ROLES.ROLE_OUTLET_ADMIN]
        },
        /*
